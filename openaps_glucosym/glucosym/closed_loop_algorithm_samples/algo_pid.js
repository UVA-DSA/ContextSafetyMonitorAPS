...
var micro=0.000001;
var obj = {"pid":{"Kp":.00888,"Ti":100,"Td":90},"sim_toggle":{"P":true,"I":true,"D":true},"BGTarget":120,"dt":5.0,"time":1000,"bioavail":6.0,"Vg":253.0,"IRss":1.3,"events":{"bolus":[{ "amt": 0.0, "start": 800 }, { "amt": 0.0, "start": 3000 }],"basal":[{ "amt": 0, "start": 100,"length":500},{ "amt": 0, "start": 2000,"length":500}],"carb":[{"amt":0.0,"start":3000,"length":90},{"amt":0.0,"start":2500,"length":90}]}};
...
fs.writeFile("glucose_output_algo_pid.txt","");
for(var i=0; i<G.length; i++){
	fs.appendFile("glucose_output_algo_pid.txt",G[i]+"\n");
}
